    ...
    <aside class="left-sidebar">
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="<?=base_url()?>admin/index" class="text-nowrap logo-img">
          ...
          <ul id="sidebarnav">
            <li class="sidebar-item">
             ...
             <li class="sidebar-item">
              ...
              <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url()?>admin/banners" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
                <span class="hide-menu">Banners Image</span>
              </a>
            </li>
            ...
            <li class="sidebar-item">
             ...
             <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url()?>admin/it_solution" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
                <span class="hide-menu">IT Solution</span>
              </a>
            </li>


             <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url()?>admin/testimonial" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
             ...
             <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url()?>admin/project" aria-expanded="false">
                ...
                <span class="hide-menu">Project Details</span>
              </a>
            </li>
              ...
              <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url()?>admin/our_team" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
              ...
              <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url()?>admin/blog" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
              ...
              <li class="sidebar-item">
              <a class="sidebar-link" href="<?=base_url()?>admin/contact_list" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
